...
class Show extends Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:8081/api/book/" + this.props.match.params.id).then(res => {
  ...
  delete(id) {
    console.log(id);
    axios.delete("http://localhost:8081/api/book/" + id).then(result => {
      ...
      <div className="container">
        <div className="panel panel-default">
          ...
          <div className="panel-body">
            ...
            <Link to={`/edit/${this.state.book._id}`} className="btn btn-success">
              Edit
            </Link>
            &nbsp;
            <button
